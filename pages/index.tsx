...
function Section_1() {
  return (
    <>
      <section className="grid grid-cols-1 gap-16 lg:grid-cols-2 wrapper">
        <div className="relative overflow-hidden rounded-md group aspect-w-16 aspect-h-9">
          <Image fill quality={40} alt="people moving into their new home" src="/media/people-movingin.jpg" className="object-cover" />
        </div>
        {/* End of Image Calander */}
        <div className="flex flex-col items-start justify-center mx-auto">
          <h1 className="display-medium w-full lg:max-w-[30ch]"> Discover Real Estate Investment Opportunities with Us!</h1>
...
function Section_3() {
  return (
    <>
      <section className="border-t">
        <div className="wrapper">
          <h3 className="display-small max-w-[40ch] text-center pt-16 mx-auto">Get Professional Real Estate Management Services Today!</h3>
          <p className="mx-auto mt-4 prose text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo quos tempore tenetur ex voluptatem. Officia aliquid explicabo dolore voluptate, et ab porro laboriosam dolor cum sapiente exercitationem sint tempora totam!</p>
        </div>
      </section>
    </>
...
function Section_4() {
  return (
    <>
      <section className="border-t">
        <div className="wrapper">
          <h4 className="display-small max-w-[40ch] text-center pt-16 mx-auto">Reap Maximum Returns on Your Real Estate Investments!</h4>
          <p className="mx-auto mt-4 prose text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo quos tempore tenetur ex voluptatem. Officia aliquid explicabo dolore voluptate, et ab porro laboriosam dolor cum sapiente exercitationem sint tempora totam!</p>
        </div>
      </section>
    </>
...
function Section_5() {
  return (
    <>
      <section className="border-t">
        <div className="wrapper">
          <h5 className="display-small max-w-[40ch] text-center pt-16 mx-auto">Streamline Your Real Estate Investment Strategies with Our Services!</h5>
          <p className="mx-auto mt-4 prose text-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo quos tempore tenetur ex voluptatem. Officia aliquid explicabo dolore voluptate, et ab porro laboriosam dolor cum sapiente exercitationem sint tempora totam!</p>
        </div>
      </section>
    </>
